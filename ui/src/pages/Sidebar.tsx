  ...
  const sideNav = [
    {
      ...
      items: [
        ...
        {
          name: nxtCustomsLabel1,
          id: htmlIdGenerator("nxtFeastRegistry")(),
        ...
        },
        {
          ...
          id: htmlIdGenerator("nxtFeastMaterialize")(),
          icon: <EuiIcon type={NxtFeastIcon16} />,
          onClick: () => {
            navigate(`/p/${projectName}/nxt-feast-materialize`);
          },
          isSelected: useMatchSubpath("nxt-feast-materialize"),
        },
      ],
    },
  ];
